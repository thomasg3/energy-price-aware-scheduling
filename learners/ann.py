...
def mlp_few_features_30_days(day, prediction_data, instance):
    historic_days = 30
...
def mlp_basic_features_30_days(day, prediction_data, instance):
    historic_days = 30
    clf = neural_network.MLPRegressor()
...
def mlp_all_features_30_days(day, prediction_data, instance):
    historic_days = 30
    clf = neural_network.MLPRegressor()
...
def mlp_few_features_90_days(day, prediction_data, instance):
    historic_days = 90
    clf = neural_network.MLPRegressor()
    predictions = core.generic_learner(few_features, column_predict, simple_preprocessors, clf,
                                       day, prediction_data, instance, historic_days)
...
def mlp_basic_features_90_days(day, prediction_data, instance):
    historic_days = 90
    clf = neural_network.MLPRegressor()
    predictions = core.generic_learner(basic_features, column_predict, simple_preprocessors, clf,
                                       day, prediction_data, instance, historic_days)
...
def mlp_all_features_90_days(day, prediction_data, instance):
    historic_days = 90
    clf = neural_network.MLPRegressor()
    predictions = core.generic_learner(all_features, column_predict, simple_preprocessors, clf,
                                       day, prediction_data, instance, historic_days)
...
def mlp_few_features_300_days(day, prediction_data, instance):
    historic_days = 300
    clf = neural_network.MLPRegressor()
    predictions = core.generic_learner(few_features, column_predict, simple_preprocessors, clf,
                                       day, prediction_data, instance, historic_days)
...
def mlp_basic_features_300_days(day, prediction_data, instance):
    historic_days = 300
    clf = neural_network.MLPRegressor()
    predictions = core.generic_learner(basic_features, column_predict, simple_preprocessors, clf,
                                       day, prediction_data, instance, historic_days)
...
def mlp_all_features_300_days(day, prediction_data, instance):
    historic_days = 300
    clf = neural_network.MLPRegressor()
    predictions = core.generic_learner(all_features, column_predict, simple_preprocessors, clf,
                                       day, prediction_data, instance, historic_days)
